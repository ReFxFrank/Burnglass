...
`discordRotateSecs` (15–300), `discordShowModel` (`false` hides the model · effort · sessions line), `discordLargeImage` (idle/fallback art key) +
